...
(function () {
  ...
  const lessons = [
    ['統計學習 · 第 2 章','2.1 什麼是統計學習？','/statistics/02_What_Is_Statistical_Learning.html'],
    ['','2.2 評估模型準確度','/statistics/02_Assessing_Model_Accuracy.html'],
    ['','2.3 Lab：Python 入門','/statistics/02_Lab_Python_Introduction.html'],
    ['第 3 章｜線性迴歸','3.1 簡單線性迴歸','/statistics/03_simple_linear_regression.html'],
    ['','3.2 多元線性迴歸','/statistics/3.2_multiple_linear_regression.html'],
    ['','3.3 迴歸模型的其他考量','/statistics/3_3_other_considerations.html'],
    ['','3.4 行銷計畫','/statistics/3.4_the_marketing_plan.html'],
    ['','3.5 線性迴歸 vs KNN','/statistics/3.5_linear_regression_vs_knn.html'],
    ['','3.6 Lab：線性迴歸','/statistics/3.6_lab_linear_regression.html'],
    ['第 4 章｜分類','4.3 邏輯回歸','/statistics/4.3_logistic_regression.html'],
    ['','4.4 生成模型（LDA/QDA）','/statistics/04_Generative_Models.html'],
    ['','4.5 分類方法比較','/statistics/04_classification_methods_comparison.html'],
    ['','4.6 廣義線性模型','/statistics/4_6_generalized_linear_models.html'],
    ['','4.7 Lab：分類方法','/statistics/04_7_lab_classification_methods.html'],
    ['第 5 章｜重抽樣','5.1 交叉驗證','/statistics/05_cross_validation.html'],
    ['','5.2 Bootstrap','/statistics/05_the_bootstrap.html'],
    ['','5.3 Lab：CV 與 Bootstrap','/statistics/05_lab_cross_validation_bootstrap.html'],
    ['第 6 章｜模型選擇','6.1 子集選擇','/statistics/6.1_subset_selection.html'],
    ['','6.2 收縮方法（Ridge/Lasso）','/statistics/6.2_shrinkage_methods.html'],
    ['','6.3 PCR 與 PLS','/statistics/6.3_pcr_pls.html'],
    ['','6.4 高維度資料','/statistics/6.4_high_dimensions.html'],
    ['','6.5 Lab：正則化','/statistics/6.5_lab_regularization.html'],
    ['第 7 章｜非線性','7.1 多項式迴歸','/statistics/7.1_polynomial_regression.html'],
    ['','7.2 階梯函數','/statistics/7.2_step_functions.html'],
    ['','7.3 基底函數','/statistics/7.3_basis_functions.html'],
    ['','7.4 迴歸樣條','/statistics/7.4_regression_splines.html'],
    ['','7.5 平滑樣條','/statistics/7.5_smoothing_splines.html'],
    ['','7.6 局部迴歸','/statistics/7.6_local_regression.html'],
    ['','7.7 廣義加法模型','/statistics/7.7_generalized_additive_models.html'],
    ['','7.8 Lab：非線性建模','/statistics/7.8_lab_nonlinear_modeling.html'],
    ['第 8 章｜樹狀方法','8.1 決策樹基礎','/statistics/8.1_decision_trees.html'],
    ['','8.2 隨機森林與 Boosting','/statistics/8.2_bagging_random_forests_boosting.html'],
    ['','8.3 Lab：決策樹','/statistics/8.3_lab_tree_methods.html'],
    ['第 9 章｜SVM','9.1 最大邊界分類器','/statistics/9.1_maximal_margin_classifier.html'],
    ['','9.2 支援向量分類器','/statistics/9.2_support_vector_classifiers.html'],
    ['','9.3 支援向量機','/statistics/9.3_support_vector_machines.html'],
    ['','9.4 多類別 SVM','/statistics/9.4_svm_multiclass.html'],
    ['','9.5 SVM 與邏輯回歸','/statistics/9.5_relationship_to_logistic_regression.html'],
    ['','9.6 Lab：SVM','/statistics/9.6_lab_svm.html'],
    ['第 10 章｜深度學習','10.1 單層神經網路','/statistics/10.1_single_layer_neural_networks.html'],
    ['','10.2 多層神經網路','/statistics/10.2_multilayer_neural_networks.html'],
    ['','10.3 卷積神經網路','/statistics/10.3_convolutional_neural_networks.html'],
    ['','10.4 文件分類','/statistics/10.4_document_classification.html'],
    ['AI Agents 入門（15 課）','1. 什麼是 AI Agent？','/ai-agents/ai-agents-01-intro.html'],
    ['','2. 探索 Agentic 框架','/ai-agents/ai-agents-02-frameworks.html'],
    ...
    ['','10. 上線實戰：可觀測性與評估','/ai-agents/ai-agents-10-production.html'],
    ['','11. 通訊協定 MCP/A2A/NLWeb','/ai-agents/ai-agents-11-protocols.html'],
